            ...
            <div className="product__inner reverse-block">
              ...
              <div className="product__banner product-reverse">
                <div className="product__banner-text">
                  ...
                  get a subpar product; I know it is going to be good. That is
                  the number one advantage of working with Exhibit Systems.
                </div>
                <div className="product__banner-block">
                  <img
                    className="product__banner-avatar"
              ...
              <div className="product__block right-text">
                ...
                <div className="product__text">
                  ...
                  beginning of the original Star Trek show really did do a good
                  job of capturing our feelings about space.
                  <br />
                  <br /> It is those feelings that drive our love of astronomy
